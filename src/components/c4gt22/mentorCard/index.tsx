    ...
    return (
        <>
            <div className="mb-10 lg:mb-16">
                <h3 className="text-4xl w-5/6 lg:w-full mx-auto lg:text-5xl text-center font-bold text-color-primary py-10">Meet the C4GT 2022 Mentors</h3>
                            ...
                            mentorsList.map((mentor, index) => (
                                <div className="flex flex-col items-center mx-auto overflow-hidden w-3/4" key={index}>
                                    ...
                                    <div className="w-72 h-24 flex-col items-center flex">
                                        <span className="font-bold text-xl text-color-dark">{mentor.name}</span>
                                        <span className="font-medium text-sm text-center text-color-dark w-3/5">{mentor.description}</span>
                                    </div>
                                </div>
                            ))
                        }
